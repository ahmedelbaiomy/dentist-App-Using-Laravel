...
<!-- Row start -->
    <div class="row my-3"> 
        <div class="col-md-12 text-right">
            <a href="#" id="new_service_btn" class="btn btn-icon btn-primary" data-toggle="modal" data-target="#add_service_modal"><span class="icon-plus1"></span></a>
        </div>
    </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-outlined" id="root_cat" placeholder="Input Root Category">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <a href="#" class="btn btn-icon btn-primary" id="rootcat_save_btn"><span class="icon-plus1"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm">
                                                    <button type="button"  data-toggle="modal" data-target="#edit_service_modal"  data-id="{{ json_encode($service) }}" class="btn btn-info">
                                                        <i class="icon-edit1"></i>
                                                    </button>
                                                    <button onclick="delete_func('delete_frm_{{ $service->id }}')"  type="button" class="btn btn-danger">
                                                        <form action="{{ route('admin.services.destroy', $service->id)}}" name="delete_frm_{{ $service->id }}" id="delete_frm_{{ $service->id }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="a_service_name" name="a_service_name" class="form-control form-control-lg" placeholder="Enter Service Name" require>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">                                                
                                        <input type="number" min="1" max="9999999999" id="a_price" name="a_price" class="form-control form-control-lg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <textarea class="form-control form-control-sm" cols="30" rows="5" id="a_note" name="a_note" placeholder="Enter Note"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button href="#" class="btn btn-primary" id="service_save_btn"><span class="icon-save"></span>&nbsp;Save</button>                                        
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="edit_service_modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="first-name">Service Name*</label>
                                            <input type="text" id="e_service_name" name="e_service_name" class="form-control form-control-lg" placeholder="Enter Service Name" require>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="default-05">Price* (USD)</label>
                                            <div class="form-control-wrap">                                                
                                                <input type="number" min="1" max="9999999999" id="e_price" name="e_price" class="form-control form-control-lg">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label" for="cf-default-textarea">Note</label>
                                            <div class="form-control-wrap">
                                                <textarea class="form-control form-control-sm" cols="30" rows="5" id="e_note" name="e_note" placeholder="Enter Note"></textarea>
                                            </div>
                                        </div>
                                    </div>                                   
                                </div>
            ...
            <div class="modal-footer">
                <button href="#" class="btn btn-primary" id="service_update_btn"><span class="icon-save"></span>&nbsp;Update</button>                                        
                <button href="#" data-dismiss="modal" class="btn btn-danger"><span class="icon-close"></span>&nbsp;Cancel</button>                                            
            </div>
        </div><!-- .modal-content -->
    </div><!-- .modal-dialog -->
