...
<link rel="stylesheet" href="{{ asset('new-assets/app-assets/vendors/css/tables/datatable/responsive.bootstrap4.min.css') }}"><link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.7.1/css/buttons.bootstrap.min.css"  type="text/css"/>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <form style="width:100%" id="formFilterSearch">
                        <div class="row">
                            <div class="form-group col-md-2">
                                <label for="">{{ __('locale.id') }} :</label>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm"
                                        name="filter_id" placeholder="" aria-describedby="button-filter" />
                                </div>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="">{{ __('locale.phone') }} :</label>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm"
                                        name="filter_phone" placeholder="" aria-describedby="button-filter" />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm"
                                        name="filter_name" placeholder="" aria-describedby="button-filter" />
                                </div>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="">{{ __('locale.iqama') }} :</label>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm"
                                        name="filter_iqama" placeholder="" aria-describedby="button-filter" />
                                </div>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="">{{ __('locale.filter_fromdate') }} :</label>
                                <div class="input-group">
                                    <input type="text" id="fromDate" class="form-control flatpickr-basic form-control-sm"
                                        value="" name="filter_fromdate" placeholder="" aria-describedby="button-filter">
                                </div>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="">{{ __('locale.filter_todate') }} :</label>
                                <div class="input-group">
                                    <input type="text" id="endDate" class="form-control flatpickr-basic form-control-sm"
                                    value="" name="filter_todate" placeholder="" aria-describedby="button-filter">
