...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            ...
            @if(Auth::user())
                ...
                <li class=" nav-item {{ Route::currentRouteName() === 'admin.requests' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('admin.requests') }}"><i data-feather="mail"></i><span class="menu-title text-truncate" data-i18n="Requests">Requests</span></a></li> 
                ...
                <li class=" nav-item {{ Route::currentRouteName() === 'nurse.home' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('nurse.home') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Dashboard</span></a></li>
                <li class=" nav-item {{ Route::currentRouteName() === 'nurse.appointment' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('nurse.appointment') }}"><i data-feather="calendar"></i><span class="menu-title text-truncate" data-i18n="Appointments">Appointments</span></a></li>
