        ...
        <div class="main-menu-content">
            ...
            @if(Auth::user())
                ...
                <li class=" nav-item {{ Route::currentRouteName() === 'doctor.profile' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('doctor.profile') }}"><i data-feather="user-x"></i><span class="menu-title text-truncate" data-i18n="My Profile">{{ __('locale.my_profile') }}</span></a></li>
                  <li class=" nav-item {{ Route::currentRouteName() === 'doctor.requests' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('doctor.requests') }}"><i data-feather="mail"></i><span class="menu-title text-truncate" data-i18n="Requests">{{ __('locale.requests') }}</span></a></li> 
