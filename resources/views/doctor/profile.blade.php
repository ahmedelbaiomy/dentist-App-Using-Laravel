            ...
            <div class="card-body">
                <h4 class="card-title">Patient info</h4>
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if (!\Session::has('success_add_invoice') && !\Session::has('success_add_note') && !\Session::has('success_paid_invoice') && !\Session::has('success_add_storage')) active @endif" data-toggle="tab" href="#tabOverview"><i class="icon-event_note nav-icon"></i><span>Overview</span></a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link @if (\Session::has('success_add_invoice')) active @endif"  id="procedures" data-toggle="tab" href="#tabProcedures"><i class="icon-event_note nav-user"></i><span>Procedures</span></a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane @if(!\Session::has('success_add_invoice') && !\Session::has('success_add_note') &&  !\Session::has('success_paid_invoice') && !\Session::has('success_add_storage')) active @endif" id="tabOverview">
                                <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table id="mytable" class="datatable table">
                                                        ...
                                                        <form id="addbillingform" action="{{ route('doctor.patient.BillingStore') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button onclick="delete_func('delete_note_{{ $note->id }}')" type="button" class="btn btn-danger">
                                                                        <form action="{{ route('doctor.note.destroy', ['id' => $note->id])}}" name="delete_note_{{ $note->id }}" id="delete_note_{{ $note->id }}" method="post">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <i class="icon-cancel"></i>
                                                                        </form>    
                                                ...
                                                <div class="table-responsive">
                                                   <a style="float: right;color: #fff;" onclick="document.getElementById('addbillingform1').submit();" class="btn btn-icon btn-primary">
                                                    ...
                                                    <table id="mytable1" class="datatable table">
                                                        ...
                                                        <tbody>
                                                        <form id="addbillingform1" action="{{ route('doctor.patient.BillingStore') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" name="patient_id" value="{{ $patient_id }}">
                                                            @foreach($services as $service)
                                                                <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($invoice->paid == 0)
                                                                        ...
                                                                        <form action="{{route('doctor.patient.BillingPaid')}}" method="post">
                                                                            @csrf
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm">
                                                                        <a href="{{route('doctor.invoice.generatepdf',$invoice->id)}}" class="btn btn-info">
                                                                            PDF
                                                                        </a>
                                                                    </div> 
                                                                </td>
                    ...
                    <form action="{{ route('file.doctoreupload.post') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li class="text-right">
                                        <button type="submit" id="storage_save_btn" class="btn btn-lg btn-primary">Save</button>
                                    </li>
                                </ul>
                            </div>
