                    ...
                    array(
                        'invoice_line_ids' => array(
                            array(0, 0, array(
                                ...
                                'price_unit'=>intval($row['quantity'])*intval($row['rate']),
            ...
            'write',
                ...
                /*array(
                    array(
                       ...
                       // 'debit'=>intval($row['quantity'])*intval($row['rate']),
                       //'credit'=>intval($row['quantity'])*intval($row['rate']),
                        //'debit'=>intval($row['quantity'])*intval($row['rate']),
