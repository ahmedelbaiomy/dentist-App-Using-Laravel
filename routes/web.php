...
//Ajax notifications
Route::get('/navbar/get/notifications/{type}', [App\Http\Controllers\AppController::class, 'navbarGetNotifications']);
...
########routes for report ###############333
Route::get('/report/pdf/pationts/daily/{doctor_id}/{mode}', [App\Http\Controllers\AppController::class, 'generatePatiantsReportPdf'])->name('admin.report.doctor');

//Daily doctors report
Route::get('/report/pdf/doctor/daily/{doctor_id}/{mode}', [App\Http\Controllers\AppController::class, 'generateDailyDoctorsReportPdf']);
...
Route::post('/sdt/appointments', [App\Http\Controllers\AppController::class, 'sdtAppointments']);
...
Route::group(['middleware' => ['auth', 'is_admin']], function () {
    ...
    Route::post('/admin/changeStatus/', [App\Http\Controllers\AppController::class, 'changedStatus']);
    ...
    Route::delete('/admin/delete/invoice/{invoice_id}', [App\Http\Controllers\AppController::class, 'deleteInvoice']);
...
Route::group(['middleware' => ['auth', 'is_doctor']], function () {
    ...
    Route::get('/doctor/requests', [App\Http\Controllers\Doctor\HomeController::class, 'requests'])->name('doctor.requests');
    Route::get('/doctor/form/patient/{patient_id}', [App\Http\Controllers\Admin\PatientController::class, 'formPatient']);
    Route::post('/doctor/form/patient', [App\Http\Controllers\Doctor\HomeController::class, 'storeFormPatient']);

    Route::post('/doctor/changeStatus/', [App\Http\Controllers\AppController::class, 'changedStatus']);
    Route::get('/doctor/form/request/{request_id}', [App\Http\Controllers\AppController::class, 'formRequest']);
    Route::post('/doctor/form/request', [App\Http\Controllers\AppController::class, 'storeFormRequestDoctor']);
    Route::post('/doctor/sdt/requests', [App\Http\Controllers\AppController::class, 'doc_sdtRequests']);
...
Route::group(['middleware' => ['auth', 'is_reception']], function () {
    ...
    Route::post('reception/change_status', [App\Http\Controllers\Reception\AppointmentController::class, 'change_appointment']);
